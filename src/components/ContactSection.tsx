...
const ContactSection = () => {
  ...
  return (
    <section ref={sectionRef} id="contact" className="py-12 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div data-reveal className="bg-blush-pink/15 p-8 rounded-sm shadow-sm border-[1px] border-blush-mauve/40">
        ...
        {/* Social icons */}
        <div data-reveal className="flex justify-center mt-12 space-x-6">
